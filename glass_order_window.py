...
firm_label.grid(row=0, column=1, padx=20, pady=20)
...
kind_label.grid(row=0, column=4, padx=20, pady=20)
...
firm_cb.grid(row=1, column=1, sticky="w", padx=20, pady=20)
...
order_label.grid(row=2, column=1, padx=20, pady=20)
